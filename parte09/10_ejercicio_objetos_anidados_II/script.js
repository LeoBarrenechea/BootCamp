...
let letraNombre = {
    ...
    fullName = prompt("escribe tu nombre y un apellido: ");
    dateofBirth = prompt("indica tu fecha de nacimiento: ");
    masOrFem = prompt("¿masculino o femenino?");

    adjective = fullName.indexOf(" ");
    adjective = letraNombre[fullName[adjective - 1]][masOrFem];

    surname = fullName.length;
    surname = letraApellido[fullName[surname - 1]][masOrFem];

    lenBirth = dateofBirth.length;
    dateofBirth = fechaNacimiento[lenBirth - 1][masOrFem];

    console.log(adjective + " " + surname + " " + dateofBirth);
